...
# **********************************************************************************************************************
source ~/.config/bash/alias/update.sh
source ~/.config/bash/alias/nushell.sh
source ~/.config/bash/alias/docker.sh
source ~/.config/bash/alias/git.sh
source ~/.config/bash/alias/pacman.sh
