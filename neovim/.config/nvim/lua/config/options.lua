...
-- Opciones de Plugins
-- Snacks.nvim
-- global.snacks_animate = true

-- LazyVim
-- global.lazyvim_picker = "auto"
-- global.lazyvim_cmp = "auto"
...
-- Opciones Condicionales (LazyVim)
if vim.fn.has("nvim-0.10") == 1 then
	-- LazyVim: Smooth scrolling
	-- opt.smoothscroll = true

	-- LazyVim: Fold configuration
